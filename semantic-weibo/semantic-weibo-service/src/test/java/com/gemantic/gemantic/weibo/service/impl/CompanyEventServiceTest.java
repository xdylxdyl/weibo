...
public class CompanyEventServiceTest {
	...
	private static final Log log = LogFactory.getLog(CompanyEventServiceTest.class);
	...
	//@Before
	    public void setUp() throws Exception{
	        ...
	        companyEventService = (CompanyEventService) context.getBean("companyEventService");
			//local server
			/**
			companyEventService = (CompanyEventService)  Naming.lookup("//localhost:8801/CompanyEventRMIService");
			**/
	...
	public void testCRUD() throws ServiceException, ServiceDaoException{
	 ...
	 // 1.增加
	  ...
	  CompanyEvent companyEvent2=this.companyEventService.getObjectById(id);
	   ...
	   List<CompanyEvent> insertResults= this.companyEventService.insertList(list);
	   ...
	   List<Long> ids=new ArrayList<Long>();
	    ...
	    List<CompanyEvent> getResults= this.companyEventService.getObjectsByIds(ids);
