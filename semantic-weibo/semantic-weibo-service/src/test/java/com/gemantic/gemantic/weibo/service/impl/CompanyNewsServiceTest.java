...
public class CompanyNewsServiceTest {
	...
	private static final Log log = LogFactory
			.getLog(CompanyNewsServiceTest.class);
	...
	public void setUp() throws Exception {
		...
		companyNewsService = (CompanyNewsService) context
				.getBean("companyNewsService");
		// local server
		/**
		 * companyNewsService = (CompanyNewsService)
		 * Naming.lookup("//localhost:8801/CompanyNewsRMIService");
		 **/
		 ...
		 * companyNewsService = (CompanyNewsService)
		 * context.getBean("companyNewsService");
		 **/
	...
	public void testCRUD() throws ServiceException, ServiceDaoException {
		...
		List<CompanyNews> insertResults = this.companyNewsService
				.insertList(list);
		...
		List<CompanyNews> getResults = this.companyNewsService
				.getObjectsByIds(ids);
